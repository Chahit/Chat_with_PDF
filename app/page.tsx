...
export default function Home() {
  ...
  const {getRootProps, getInputProps, isDragActive} = useDropzone({onDrop,
      multiple: false, // Example of including the 'multiple' property
      onDragEnter: () => {}, // Example of including an empty function for 'onDragEnter'
      onDragOver: () => {}, // Example of including an empty function for 'onDragOver'
      onDragLeave: () => {}, // Example of including an empty function for 'onDragLeave'
    });
